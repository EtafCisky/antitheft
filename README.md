...
**作者 / Author:** EtafCisky  
**许可协议 / License:** CC BY-ND 4.0  
**版权 / Copyright:** © 2026 EtafCisky. All rights reserved.
...
本插件采用 **CC BY-ND 4.0**（知识共享署名-禁止演绎 4.0 国际许可协议）进行许可。

### 这意味着

- ✅ **允许分享** — 可以原样复制和分发本插件
- ✅ **允许商业使用** — 可以用于商业目的
- ✅ **必须署名** — 必须注明作者为 EtafCisky
- ❌ **禁止修改后分发** — 不得分发任何修改版本
- ❌ **禁止二次传播修改版** — 不得基于本作品创作衍生作品并分发

详细信息请查看 [LICENSE.md](./LICENSE.md) 文件。

**作者:** EtafCisky  
**版权:** © 2024 EtafCisky. All rights reserved.
